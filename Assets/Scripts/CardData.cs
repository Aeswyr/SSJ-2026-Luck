...
public enum CardID
{
    ...
    HIGHER_CARD, HIGHEST_CARD, 
    JUDGEMENT, TRIAL_BY_STEEL, SINNERS_GUILT, REDEEMER, INESCAPABLE_AGONY, FINAL_VERDICT 
}
...
public enum KeywordID
{
    ...
    COMEDY, MARK, BLEED, PAIN, EMPOWER, PRESCIENCE, GUILT
}